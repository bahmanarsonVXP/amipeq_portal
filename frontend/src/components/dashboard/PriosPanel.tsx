...
function PrioCardItem({
  ...
  return (
    <div className={`rounded-xl p-3 border ${col.cardBg} ${col.cardBorder}`}>
      ...
      {col.showActions && (
        <div className="flex flex-wrap gap-1.5">
          ...
          <button className="text-xs font-medium px-2.5 py-1 rounded-lg border border-gray-200 bg-white text-gray-600">
            Email
          </button>
          <button
...
function PrioColumn({
  ...
  return (
    <div className="flex flex-col flex-1 min-w-0">
      <div className={`rounded-t-xl px-3 py-2.5 border border-b-0 ${col.headBg} ${col.headBorder}`}>
      ...
      <div className={`flex-1 border border-t-0 rounded-b-xl p-2 flex flex-col gap-2 bg-white min-h-[360px] ${col.bodyBorder}`}>
        {cards.length === 0 ? (
